      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none text-foreground/80 space-y-8">
            <p>
              This Cookie Policy explains the use of cookies and similar technologies on our website at
              https://zeeroni.com (the "Site"), operated by Khar Meets Gundruk Tech Private Ltd ("Company," "we," "us,"
              or "our").
            </p>
            ...
            <section>
              ...
              <p>
                Our website does not use cookies or any similar tracking technologies. We respect your privacy and have
                designed our website to function without collecting data through cookies.
              </p>
            ...
            <section>
              ...
              <p>
                If we decide to use cookies in the future, we will update this policy and notify users accordingly. Any
            ...
            <section>
              ...
              <div className="mt-4 space-y-2">
                <p>
                  <strong>Khar Meets Gundruk Tech Private Ltd</strong>
                </p>
